...
const Timeline: React.FC<TimelineProps> = ({ onYearChange }) => {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="fixed left-0 top-0 w-80 h-screen flex-shrink-0 pl-8 pr-8 z-20">
      ...
      {/* Right Side - Scrollable Content for Selected Decade */}
      <div className="ml-80 flex-1 h-screen overflow-y-auto pr-8 pt-8">
            ...
            <div className="space-y-3">
              ...
              <div className="grid gap-1 max-w-md">
                {currentDecadeJobs.map((job, index) => (
                  <div 
                    key={index} 
                    className="bg-gradient-to-l from-blue-600 to-blue-700 rounded-lg p-2 border border-gray-600 transition-all duration-300 cursor-pointer hover:scale-105 hover:shadow-xl min-w-36"
