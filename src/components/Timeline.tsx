  ...
  return (
    <>
      <div className="relative min-h-screen flex flex-col items-center justify-start pt-20 pb-32">
        ...
        {/* Timeline Line */}
        <div id="timeline" className="absolute left-32 w-1 bg-gradient-to-b from-silver-400 via-orange-200 to-orange-500 opacity-80" style={{ top: "7.8rem", height: getTimelineHeight() }}></div>
